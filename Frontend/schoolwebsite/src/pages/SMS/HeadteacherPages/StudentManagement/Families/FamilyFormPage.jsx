    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const payload = {
                ...
                sub_county: formData.sub_county.trim(),
            ...
            const savedFamily = response.data;

            // After creating, go directly to the family details page.
            // After editing, also return to the updated family.
            navigate(`/sms/families/${savedFamily.id || id}`);
        } catch (err) {
            ...
            if (data && typeof data === "object") {
                ...
                setError(
                    messages || "Failed to save the family information."
                );
            } else {
                setError(
